...
const boxInitialState: Editor.IFeatureState = {
  name: '容器组件',
  style: {
    visibility: 'visible',
    margin: '0px',
...
function boxReducer(action: Editor.IAction, state = boxInitialState) {
  return state;
}

class Box extends React.Component<Editor.IWrappedFeatureComponentProps, {}> {
  public render() {
...
export const containerInitialState: Readonly<Editor.IFeatureState> = {
  name: '容器',
  style: {
    visibility: 'visible',
    margin: '0px',
...
export function containerReducer(action: Editor.IAction, state = containerInitialState) {
...
export const containerOption: Editor.IFeatureOption = {
  resizer: true,
  container: true,
  history: false
};

export class RawContainer extends React.Component<Editor.IWrappedFeatureComponentProps, {}> {
