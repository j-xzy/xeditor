...
import { Expression as ExpNode, useDataDriver } from '../../src';
import './style.styl';
      ...
      <div>
        <span>width</span>
        {
          bindedNode && bindedNode['style.width'] ?
            <>
              <Expression flag={`binded-${state.id}-style.width}`} getFeatureById={d.getFeatureById} nodes={bindedNode['style.width'].getChildren() as ExpNode[]} />
